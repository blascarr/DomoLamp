...
const char LAMPPAGE_BODY[] PROGMEM = "<body><div id='lm'></div><div id='cs'><input id='cp' type='color' value='#00ff00' list='ps'></div><div id='sliders'><input id='ds' type='range' min='0' max='2000' value='50'><div id='dl'>50</div><input id='bs' type='range' min='0' max='100' value='50'><div id='bl'>50</div></div><div><button id='sb'> Send </button></div><div><button id='wo'> Wifi OFF </button></div></body>";
